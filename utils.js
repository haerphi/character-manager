...
function axiosDelete(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1["default"]["delete"]("https://character-database.becode.xyz/characters/" + id)
                        .then(function (rep) {
                        return rep.data;
                    })];
                case 1: return [2 /*return*/, _a.sent()];
...
function axiosPut(id, data) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1["default"].put("https://character-database.becode.xyz/characters/" + id, data)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
